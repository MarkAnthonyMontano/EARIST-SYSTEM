        ...
        <div className="px-8 p-2 w-full flex">
           ...
           <div className="relative ">
                <Link to={'/register_prof'}>
                    ...
                    <button className="bg-white text-maroon-500 border-4 rounded-lg border-solid border-maroon-500 p-4 w-[16rem] rounded-md h-32 font-medium mr-3 mt-16 ml-8 flex items-end justify-center">ACCOUNT PROFESSOR</button>
                </Link>
            </div>
