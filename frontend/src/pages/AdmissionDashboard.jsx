            ...
            <div className="p-2 px-10 w-full grid grid-cols-3">
                ...
                <div className="relative mb-10">
                    <Link to={'/student_requirements'}>
                        ...
                        <button className="bg-white text-maroon-500 border-4 rounded-lg border-solid border-maroon-500 p-4 w-80 rounded-md h-32 font-medium mr-4 mt-16 ml-8 flex items-end justify-center">STUDENT REQUIREMENTS</button>
                    </Link>
                </div>
